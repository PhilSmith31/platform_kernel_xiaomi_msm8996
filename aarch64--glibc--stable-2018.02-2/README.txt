aarch64--glibc--stable-2018.02-2
...
glibc          glibc-2.26-144-gbbabb868cd248763373d0db763bacd84ce27ede8  GPL-2.0+ (programs), LGPL-2.1+, BSD-3-Clause, MIT (library)
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.free-electrons.com/downloads/releases/toolchains/aarch64/build_fragments/aarch64--glibc--stable-2018.02-2.defconfig > .config
    make olddefconfig
    make
